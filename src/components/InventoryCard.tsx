...
const getCategoryConfig = (category: InventoryItem['category']) => {
    switch (category) {
        ...
        case 'Snacks':
            return { emoji: '🍿', bg: 'from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30', border: 'border-orange-100 dark:border-orange-800/50', accent: 'text-orange-600 dark:text-orange-400' };
        default:
...
const getOpenedExpiryInfo = (category: InventoryItem['category']): string => {
    switch (category) {
        ...
        case 'Snacks': return 'Reduces to 14 days';
